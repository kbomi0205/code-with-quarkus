...
// if (!query) return;
// window.open('https://www.riotgames.com/ko/search?q=' + encodeURIComponent(query), '_blank');
// });
...
// ── 챔피언 데이터 ──────────────────────────────────────────────
const CHAMPIONS = [
    { name: '아트록스', engName: 'Aatrox', role: '전사', lane: '탑', img: 'image/a1.jpg', difficulty: '상' },
    { name: '사일러스', engName: 'Sylas', role: '마법사', lane: '정글/미드', img: 'image/sylas.jpg', difficulty: '중' },
    { name: '애니비아', engName: 'Anivia', role: '마법사', lane: '미드', img: 'image/anivia.jpg', difficulty: '상' },
    { name: '브라이어', engName: 'Briar', role: '전사', lane: '정글', img: 'image/briar.jpg', difficulty: '중' },
    { name: '잭스', engName: 'Jax', role: '전사', lane: '탑', img: 'image/jax.jpg', difficulty: '하' },
    { name: '징크스', engName: 'Jinx', role: '원거리딜러', lane: '원딜', img: 'image/jinx.jpg', difficulty: '중' },
    { name: '멜', engName: 'Mel', role: '마법사', lane: '미드', img: 'image/mel.jpg', difficulty: '중' },
    { name: '유나라', engName: 'Yunara', role: '원거리 딜러', lane: '바텀', img: 'image/yunara.jpg', difficulty: '중' },
    { name: '자헨', engName: 'Jahen', role: '전사', lane: '탑', img: 'image/jahen.jpg', difficulty: '상' }
...
switchCategory('champion', document.querySelector('.search-category-item')); // 챔피언 탭이 먼저 보임
...
document.getElementById('searchResults').classList.remove('d-none'); // 결과 섹션 표시
